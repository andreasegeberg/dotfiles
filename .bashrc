...
# andreas
# Show the branch if we're in a git repo. Show a brown repo name if there's 
# no changes or red if there are changes in the repo.
git_branch() {
...
# andreas
# This is the function and alias which builds the Cscope database.
...
# andreas
# Set shortcut to guider
alias guider='cd /media/andreas/BACKUP/westermo/guider'
